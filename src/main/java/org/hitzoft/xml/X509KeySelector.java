...
public class X509KeySelector extends KeySelector {
     ...
     * @param method the algorithm method that this key is to be used for. Only
     * keys that are compatible with the algorithm and meet the constraints of
     * the specified algorithm should be returned.
     ...
     * considered an exception (<code>null</code> should be returned in that
     * case). However, an error condition (ex: network communications failure)
     * that prevented the <code>KeySelector</code> from finding a potential key
     * should be considered an exception.
     * @throws ClassCastException if the data type of <code>method</code> is not
     * supported by this key selector
     */
